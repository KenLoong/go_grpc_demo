...
const (
	ProdAreas_A ProdAreas = 0 //枚举类型，第一个必须是0
...
func (x *ProResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProResponse) ProtoMessage() {}

func (x *ProResponse) ProtoReflect() protoreflect.Message {
	mi := &file_Prod_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProResponse.ProtoReflect.Descriptor instead.
func (*ProResponse) Descriptor() ([]byte, []int) {
	return file_Prod_proto_rawDescGZIP(), []int{1}
}

func (x *ProResponse) GetProdStock() int32 {
	if x != nil {
		return x.ProdStock
	}
	return 0
...
type ProStockList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	//定义切片
	Prodres []*ProResponse `protobuf:"bytes,1,rep,name=prodres,proto3" json:"prodres,omitempty"`
}

func (x *ProStockList) Reset() {
	*x = ProStockList{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProStockList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProStockList) ProtoMessage() {}

func (x *ProStockList) ProtoReflect() protoreflect.Message {
	mi := &file_Prod_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProStockList.ProtoReflect.Descriptor instead.
func (*ProStockList) Descriptor() ([]byte, []int) {
	return file_Prod_proto_rawDescGZIP(), []int{3}
}

func (x *ProStockList) GetProdres() []*ProResponse {
	if x != nil {
		return x.Prodres
	}
	return nil
...
var file_Prod_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x58, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x17, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x06, 0x70, 0x72, 0x6f, 0x64, 0x49, 0x64, 0x12, 0x30, 0x0a, 0x09, 0x70, 0x72, 0x6f,
	0x64, 0x5f, 0x61, 0x72, 0x65, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x41, 0x72, 0x65, 0x61,
	0x73, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x64, 0x41, 0x72, 0x65, 0x61, 0x22, 0x2c, 0x0a, 0x0b, 0x50,
	0x72, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x72,
	...
	,
	...
	,
...
var file_Prod_proto_goTypes = []interface{}{
	...
	(*ProResponse)(nil),  // 2: services.ProResponse
	(*QuerySize)(nil),    // 3: services.QuerySize
	(*ProStockList)(nil), // 4: services.ProStockList
	(*ProModel)(nil),     // 5: ProModel
}
var file_Prod_proto_depIdxs = []int32{
	0, // 0: services.ProdRequest.prod_area:type_name -> services.ProdAreas
	2, // 1: services.ProStockList.prodres:type_name -> services.ProResponse
	...
	2, // 5: services.ProdService.GetProdStock:output_type -> services.ProResponse
	4, // 6: services.ProdService.GetProdStocks:output_type -> services.ProStockList
	5, // 7: services.ProdService.GetProdInfo:output_type -> ProModel
...
type ProdServiceClient interface {
	GetProdStock(ctx context.Context, in *ProdRequest, opts ...grpc.CallOption) (*ProResponse, error)
	GetProdStocks(ctx context.Context, in *QuerySize, opts ...grpc.CallOption) (*ProStockList, error)
	GetProdInfo(ctx context.Context, in *ProdRequest, opts ...grpc.CallOption) (*ProModel, error)
}
...
func (c *prodServiceClient) GetProdStock(ctx context.Context, in *ProdRequest, opts ...grpc.CallOption) (*ProResponse, error) {
	out := new(ProResponse)
...
func (c *prodServiceClient) GetProdStocks(ctx context.Context, in *QuerySize, opts ...grpc.CallOption) (*ProStockList, error) {
	out := new(ProStockList)
...
func (c *prodServiceClient) GetProdInfo(ctx context.Context, in *ProdRequest, opts ...grpc.CallOption) (*ProModel, error) {
	out := new(ProModel)
...
type ProdServiceServer interface {
	GetProdStock(context.Context, *ProdRequest) (*ProResponse, error)
	GetProdStocks(context.Context, *QuerySize) (*ProStockList, error)
	GetProdInfo(context.Context, *ProdRequest) (*ProModel, error)
}
...
func (*UnimplementedProdServiceServer) GetProdStock(context.Context, *ProdRequest) (*ProResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetProdStock not implemented")
}
func (*UnimplementedProdServiceServer) GetProdStocks(context.Context, *QuerySize) (*ProStockList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetProdStocks not implemented")
}
func (*UnimplementedProdServiceServer) GetProdInfo(context.Context, *ProdRequest) (*ProModel, error) {
